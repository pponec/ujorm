 ...
 * @author Pavel Ponec
 */
public interface ListUjoProperty<UJO extends Ujo, LIST extends List<ITEM>,ITEM> extends UjoProperty<UJO,LIST> {
    ...
    /**
     * Returns a value of property. The result is the same, like Ujo#readValue(ListUjoProperty).
     */
