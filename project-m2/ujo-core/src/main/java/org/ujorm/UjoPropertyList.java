...
public interface UjoPropertyList extends KeyList<Ujo> {
     ...
     * @param throwException If result not found an Exception is throwed, or a null can be returned.
     * @hidden
     * @deprecated Use the method {@link #findDirectKey(java.lang.String, boolean) }
     */
    @Deprecated
    @SuppressWarnings("deprecation")
    public UjoProperty findDirectProperty
    ( final Ujo ujo
    , final String name
     ...
     * @deprecated Use the method {@link #getFirstKey() }
     */
    @Deprecated
    public UjoProperty getFirstProperty();

    /** Get the last Property
     * @deprecated Use the method {@link #getLastKey()}
     */
    @Deprecated
