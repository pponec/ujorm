...
import static org.ujorm.core.criterion.ValueCriterion.SPACE;
...
public class BinaryCriterion extends Criterion {
    ...
    /** Left Criterion */
    final private Criterion crn1;
    /** Right Criterion */
    final private Criterion crn2;
    /** Operator */
    ...
    @Override
    public final Criterion getRightNode() {
        return crn2;
    }
