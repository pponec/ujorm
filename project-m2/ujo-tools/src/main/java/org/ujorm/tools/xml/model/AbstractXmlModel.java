...
import org.ujorm.tools.xml.model.AbstractXmlModel.RawEnvelope;
 ...
 * @author Pavel Ponec
 */
public abstract class AbstractXmlModel<E extends AbstractXmlModel<?>> implements ApiElement<E>, Serializable {
     ...
     */
    public AbstractXmlModel(@Nonnull final CharSequence name) {
        this.name = name.toString();
    }

    /** New element with a parent */
    public AbstractXmlModel(@Nonnull final CharSequence name, @Nonnull final AbstractXmlModel parent) {
        this(name);
    ...
    @Nonnull
    public final E addElement(@Nonnull final E element) {
...
//     */
//    @Override @Nonnull
//    public E addElement(@Nonnull final String name) {
//        return (E) new AbstractXmlModel(name, this);
//    }
