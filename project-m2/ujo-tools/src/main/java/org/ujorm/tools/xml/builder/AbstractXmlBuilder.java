 ...
 * @author Pavel Ponec
 */
public abstract class AbstractXmlBuilder<E extends AbstractXmlBuilder<?>> implements ApiElement<E> {
    ...
    /** Node writer */
    @Nonnull
    protected final XmlPrinter writer;
     ...
     */
    public AbstractXmlBuilder(@Nonnull final CharSequence name, @Nonnull final XmlPrinter writer, final int level) {
     ...
     */
    protected AbstractXmlBuilder(@Nonnull final CharSequence name, @Nonnull final XmlPrinter writer, final int level, final boolean printName) {
    ...
    public AbstractXmlBuilder(@Nonnull final CharSequence name, @Nonnull final XmlPrinter writer) {
        this(name, writer, 0);
    }
     ...
     */
    @Nonnull
    protected E nextChild(@Nullable final E element) {
...
//     */
//    @Override @Nonnull
//    public final E addElement(@Nonnull final String name) {
//        AbstractXmlBuilder xb = new AbstractXmlBuilder(name, writer, level + 1, false);
//        return nextChild(xb);
//    }
     ...
     */
    @Override @Nonnull
    public final E setAttribute(@Nonnull final String name, @Nullable final Object value) {
    ...
    @Override @Nonnull
    public final E addText(@Nullable final Object value) {
        try {
            nextChild(null);
     ...
     * @return This instance */
    @Override @Nonnull
    public final E addRawText(@Nullable final Object value) {
        try {
            nextChild(null);
    ...
    public final E addComment(@Nullable final CharSequence comment) {
     ...
     */
    @Override @Nonnull @Deprecated
    public final E addCDATA(@Nullable final CharSequence charData) {
        throw new UnsupportedOperationException();
    }
