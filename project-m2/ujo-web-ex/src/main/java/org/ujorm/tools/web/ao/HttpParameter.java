...
public interface HttpParameter extends CharSequence {
    ...
    default boolean of(@NotNull final URequest request, @Nullable final boolean defaultValue) {
        switch (of(request)) {
            case "true":
                return true;
            case "false":
    ...
    /** Returns a parameter of the request or the default value */
    default char of(@NotNull final URequest request, @Nullable final char defaultValue) {
        final String value = of(request);
        return value.isEmpty() ? defaultValue : value.charAt(0);
    }

    /** Returns a parameter of the request or the default value */
    default short of(@NotNull final URequest request, @Nullable final short defaultValue) {
    ...
    /** Returns a parameter of the request or the default value */
    default int of(@NotNull final URequest request, @Nullable final int defaultValue) {
        final String value = of(request, EMPTY_VALUE);
        if (value.isEmpty()) {
            return defaultValue;
        } else try {
    ...
    /** Returns a parameter of the request or the default value */
    default long of(@NotNull final URequest request, @Nullable final long defaultValue) {
        final String value = of(request, EMPTY_VALUE);
        if (value.isEmpty()) {
            return defaultValue;
        } else try {
    ...
    /** Returns a parameter of the request or the default value */
    default float of(@NotNull final URequest request, @Nullable final float defaultValue) {
        final String value = of(request, EMPTY_VALUE);
        if (value.isEmpty()) {
            return defaultValue;
        } else try {
    ...
    /** Returns a parameter of the request or the default value */
    default double of(@NotNull final URequest request, @Nullable final double defaultValue) {
        final String value = of(request, EMPTY_VALUE);
        if (value.isEmpty()) {
            return defaultValue;
        } else try {
    ...
    @NotNull
    default <V extends Enum<V>> V of(@NotNull final URequest request, @NotNull final V defaultValue) {
    ...
    /** Returns a parameter of the request or the default value */
    @Nullable
    default <V extends Enum<V>> V of(@NotNull final URequest request, @NotNull final Class<V> clazz) {
        final String value = of(request);
    ...
    /** Returns a parameter of the request or the default value */
    default <V> V of(@NotNull final URequest request, @NotNull final V defaultValue, @NotNull final Function<String, V> decoder) {
        final String value = of(request, EMPTY_VALUE);
        if (value.isEmpty()) {
            return defaultValue;
        } else try {
