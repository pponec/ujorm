 ...
 */
public class KeyColumnDate<U extends Ujo> extends KeyColumn<U, java.sql.Date> {
    private static final long serialVersionUID = 1L;

    /** Default CSS class for  */
    protected static String DEFAULT_CLASS = "date";

    public KeyColumnDate(KeyRing<U> key, KeyRing<U> keySortable, String cssClass) {
    ...
    protected String getDatePattern(Component component) {
        return component.getString("locale.datetime.pattern", null, DateField.DEFAULT_DATE_PATTERN);
    }
