...
final public class MetaParams extends AbstractMetaModel {
    ...
    /** Property Factory */
    private static final PropertyFactory<MetaParams> fa = PropertyFactory.CamelBuilder.get(CLASS);
    /** Session cache policy. 
     * The default value is PROTECTED_CACHE.
     * @see CachePolicy Parameter values */
    public static final UjoProperty<MetaParams,CachePolicy> CACHE_POLICY = fa.newProperty("cachePolicy", CachePolicy.PROTECTED_CACHE);
    /** Special prameter for an automatically assembled table alias prefix.
     * The default value is the empty string. */
    public static final UjoProperty<MetaParams,String> TABLE_ALIAS_PREFIX = fa.newProperty("tableAliasPrefix", "");
    /** Special prameter for an automatically assembled table alias prefix.
     * The default value is the empty String. */
    public static final UjoProperty<MetaParams,String> TABLE_ALIAS_SUFFIX = fa.newProperty("tableAliasSuffix", "");
    ...
    public static final UjoProperty<MetaParams,Integer> SEQUENCE_CACHE = fa.newProperty("sequenceCache", 100);
    /** A policy to defining the database structure by a DDL.
     * The default value is option: CREATE_OR_UPDATE_DDL.
     * @see Orm2ddlPolicy Parameter values
     */
    public static final UjoProperty<MetaParams,Orm2ddlPolicy> ORM2DLL_POLICY = fa.newProperty("orm2ddlPolicy", Orm2ddlPolicy.CREATE_OR_UPDATE_DDL);
     ...
     */
    public static final UjoProperty<MetaParams,CommentPolicy> COMMENT_POLICY = fa.newProperty("commentPolicy", CommentPolicy.ON_ANY_CHANGE);
    ...
    public static final UjoProperty<MetaParams,File> SAVE_CONFIG_TO_FILE = fa.newProperty("saveConfigToFile");
     ...
     */
    public static final UjoProperty<MetaParams,Class<? extends ITypeService>> TYPE_SERVICE = fa.newClassProperty("typeService", TypeService.class);
     ...
     */
    public static final UjoProperty<MetaParams,CheckReport> CHECK_KEYWORDS = fa.newProperty("checkKeywords", CheckReport.EXCEPTION);
     ...
     */
    public static final UjoProperty<MetaParams,Integer> MAX_ITEM_COUNT_4_IN = fa.newProperty("maxItemCountForIN", 500);
     ...
     */
    public static final UjoProperty<MetaParams,Boolean> SEQUENCE_SCHEMA_SYMBOL = fa.newProperty("sequenceSchemaSymbol", false);
     ...
     */
    public static final UjoProperty<MetaParams,Boolean> INHERITANCE_MODE = fa.newProperty("inheritanceMode", true);
     ...
     */
    public static final UjoProperty<MetaParams,Integer> INSERT_MULTIROW_ITEM_LIMIT = fa.newProperty("insertMultirowItemLimit", 100);

    /** The parameter contains the special parameters with for different use. 
     * @see MoreParams
     */
    public static final UjoProperty<MetaParams,MoreParams> MORE_PARAMS = fa.newProperty("moreParams");
     ...
     */
    public static final UjoProperty<MetaParams,Boolean> LOG_METAMODEL_INFO = fa.newProperty("metamodelLogInfo", true);
     ...
     */
    public static final UjoProperty<MetaParams,Boolean> LOGBACK_LOGGING_SUPPORT = fa.newProperty("logbackLoggingSupport", false);

    /** An application context for initializaton of the customer componets of the meta-model. */
    @Transient
    public static final UjoProperty<MetaParams,Object> APPL_CONTEXT = fa.newProperty("applContext");
