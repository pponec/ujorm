...
public class EntityManagerService {
     ...
     * <p>
     * Note: This map is used with Double-Checked Locking in the {@code entityManager} method
     ...
     *   A recursive call to {@code entityManager} during handler creation inside {@code computeIfAbsent()} would
