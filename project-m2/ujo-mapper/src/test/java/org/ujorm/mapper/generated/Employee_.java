...
/** Key superior */
static final class Key_superior extends AbstractKey<Employee, org.ujorm.mapper.demo.Employee> {
    public Key_superior(final int order) {
        super(order, "superior", org.ujorm.mapper.demo.Employee.class, "superior_id", false, false);
    }
    @Override
    public void setValue(@NotNull final Employee bean, @Nullable final org.ujorm.mapper.demo.Employee value) {
        bean.setSuperior(value != null ? value : defaultValue);
    }
    @Override
    public org.ujorm.mapper.demo.Employee getValue(@NotNull final Employee bean) {
