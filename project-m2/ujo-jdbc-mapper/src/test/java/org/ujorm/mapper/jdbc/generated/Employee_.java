...
import org.ujorm.mapper.jdbc.ResultSetMapperKeyTest;
import org.ujorm.mapper.jdbc.ResultSetMapperKeyTest.Employee;
...
static final class Key_city extends AbstractKey<Employee, ResultSetMapperKeyTest.City> {
    ...
    @Override
    public ResultSetMapperKeyTest.City getValue(@NotNull final Employee bean) {
        return bean.getCity();
    }
    @Override
    public @NotNull Class<Employee> domainClass() {
...
static final class Key_boss extends AbstractKey<Employee, ResultSetMapperKeyTest.Employee> {
    ...
    @Override
    public ResultSetMapperKeyTest.Employee getValue(@NotNull final Employee bean) {
        return bean.getBoss();
    }
    @Override
    public @NotNull Class<Employee> domainClass() {
